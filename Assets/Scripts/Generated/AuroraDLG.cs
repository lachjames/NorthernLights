...
[Serializable]public class AuroraDLG : AuroraStruct {
    ...
    [GFF("NextNodeID", Compatibility.KotOR, ExistsIn.BASE)] public Int32 NextNodeID;
    [GFF("DeletedVOFiles", Compatibility.KotOR, ExistsIn.BASE)] public CExoString DeletedVOFiles;
    [GFF("PostProcOwner", Compatibility.KotOR, ExistsIn.BASE)] public Int32 PostProcOwner;
    [GFF("AlienRaceOwner", Compatibility.KotOR, ExistsIn.BASE)] public Int32 AlienRaceOwner;
    [GFF("RecordNoVO", Compatibility.KotOR, ExistsIn.BASE)] public Int32 RecordNoVO;
    [GFF("EditorInfo", Compatibility.KotOR, ExistsIn.BASE)] public CExoString EditorInfo;
    ...
    [Serializable]public class AEntry : AuroraStruct {
        ...
        [GFF("Script2", Compatibility.KotOR, ExistsIn.BASE)] public String Script2;
        [GFF("ActionParam1", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam1;
        [GFF("ActionParam2", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam2;
        [GFF("ActionParam3", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam3;
        [GFF("ActionParam4", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam4;
        [GFF("ActionParam5", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam5;
        [GFF("ActionParam1b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam1b;
        [GFF("ActionParam2b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam2b;
        [GFF("ActionParam3b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam3b;
        [GFF("ActionParam4b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam4b;
        [GFF("ActionParam5b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 ActionParam5b;
        [GFF("ActionParamStrA", Compatibility.KotOR, ExistsIn.BASE)] public CExoString ActionParamStrA;
        [GFF("ActionParamStrB", Compatibility.KotOR, ExistsIn.BASE)] public CExoString ActionParamStrB;
        [GFF("NodeUnskippable", Compatibility.KotOR, ExistsIn.BASE)] public Int32 NodeUnskippable;
        [GFF("PostProcNode", Compatibility.KotOR, ExistsIn.BASE)] public Int32 PostProcNode;
        [GFF("AlienRaceNode", Compatibility.KotOR, ExistsIn.BASE)] public Int32 AlienRaceNode;
        [GFF("Emotion", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Emotion;
        [GFF("RecordVO", Compatibility.KotOR, ExistsIn.BASE)] public Int32 RecordVO;
        [GFF("RecordNoVOOverri", Compatibility.KotOR, ExistsIn.BASE)] public Int32 RecordNoVOOverri;
        [GFF("FacialAnim", Compatibility.KotOR, ExistsIn.BASE)] public Int32 FacialAnim;
        [GFF("NodeID", Compatibility.KotOR, ExistsIn.BASE)] public Int32 NodeID;
        [GFF("VOTextChanged", Compatibility.KotOR, ExistsIn.BASE)] public Byte VOTextChanged;
        [GFF("Changed", Compatibility.KotOR, ExistsIn.BASE)] public Byte Changed;
        [GFF("RecordNoOverri", Compatibility.KotOR, ExistsIn.BASE)] public Int32 RecordNoOverri;
        ...
        [Serializable]public class AReplies : AuroraStruct {
            ...
            [GFF("Active2", Compatibility.KotOR, ExistsIn.BASE)] public String Active2;
            [GFF("Param1", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param1;
            [GFF("Param2", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param2;
            [GFF("Param3", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param3;
            [GFF("Param4", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param4;
            [GFF("Param5", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param5;
            [GFF("Param1b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param1b;
            [GFF("Param2b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param2b;
            [GFF("Param3b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param3b;
            [GFF("Param4b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param4b;
            [GFF("Param5b", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Param5b;
            [GFF("Not", Compatibility.KotOR, ExistsIn.BASE)] public Byte Not;
            [GFF("Not2", Compatibility.KotOR, ExistsIn.BASE)] public Byte Not2;
            [GFF("Logic", Compatibility.KotOR, ExistsIn.BASE)] public Int32 Logic;
            [GFF("ParamStrA", Compatibility.KotOR, ExistsIn.BASE)] public CExoString ParamStrA;
            [GFF("ParamStrB", Compatibility.KotOR, ExistsIn.BASE)] public CExoString ParamStrB;
    ...
    [Serializable]public class AReply : AuroraStruct {
        ...
        [GFF("NodeID", Compatibility.KotOR, ExistsIn.BASE)] public Int32 NodeID;
        [GFF("RecordNoOverri", Compatibility.KotOR, ExistsIn.BASE)] public Int32 RecordNoOverri;
        [GFF("VOTextChanged", Compatibility.KotOR, ExistsIn.BASE)] public Int32 VOTextChanged;
    ...
    [Serializable]public class AStarting : AuroraStruct {
        ...
        [GFF("ParamStrA", Compatibility.KotOR, ExistsIn.BASE)] public CExoString ParamStrA;
        [GFF("ParamStrB", Compatibility.KotOR, ExistsIn.BASE)] public CExoString ParamStrB;
        [GFF("IsChild", Compatibility.KotOR, ExistsIn.BASE)] public Byte IsChild;
